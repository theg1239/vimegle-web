          ...
          <ScrollArea className="h-96 bg-black p-6 rounded-lg overflow-y-auto">
            <div className="prose prose-invert prose-gray">
              ...
              <p className="text-gray-400">
                Even though we do not require account creation, we may collect
              ...
              <ul className="list-disc list-inside text-gray-400">
                <li>
                  ...
                  address when you use the Service.
                </li>
                <li>
                  <strong>Browser Information:</strong> Details about your
                  browser type, version, and settings.
                </li>
                <li>
                  <strong>Device Information:</strong> Information about the
                  device you use to access the Service, including operating
              ...
              <ul className="list-disc list-inside text-gray-400">
                <li>
                  ...
                  interact with the Service, such as the pages you visit, the
                  time and duration of your visits, and other diagnostic data.
                </li>
                <li>
                  <strong>Cookies and Tracking Technologies:</strong> We use
                  cookies and similar tracking technologies to track activity on
                  the Service and hold certain information.
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside text-gray-400">
                <li>
                  <strong>Providing the Service:</strong> To facilitate
                  real-time communication between users.
                </li>
                <li>
                  <strong>Improving the Service:</strong> To understand how
                  users interact with the Service and to improve its
                  functionality and user experience.
                </li>
                <li>
                  <strong>Security:</strong> To monitor and protect the Service
                  from unauthorized access, attacks, or other security threats.
                </li>
                <li>
              ...
              <p className="text-gray-400">
                ...
                Specifically, since we do not store user data beyond what is
                necessary to display messages via the socket, any transient data
                is not retained beyond the active session.
              </p>
              ...
              <ul className="list-disc list-inside text-gray-400">
                ...
                <li>
                  <strong>Restriction:</strong> The right to request the
              ...
              <p className="text-gray-400">
                ...
                under 18. If we become aware that we have inadvertently received
              ...
              <p className="text-gray-400">
                ...
                the privacy practices or content of these third parties. We
              ...
              <p className="text-gray-400">
                ...
                the top of this document. Your continued use of the Service
